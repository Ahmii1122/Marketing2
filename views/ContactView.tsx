...
const ContactView: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (
      ...
      setStatus("error");
      setErrorMessage(
        "Please configure your EmailJS credentials in views/ContactView.tsx",
      );
      return;
    }
    ...
    if (!window.emailjs) {
      setStatus("error");
      setErrorMessage(
        "EmailJS is still loading. Please try again in a moment.",
      );
      return;
    }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20 max-w-2xl">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed">
            Ready to scale your digital presence? Fill out the form below or
            reach out directly to our team. We usually respond within 24 hours.
          </p>
        </div>
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                    Plaza 23, Sunflower Commercial, Bahria Nasheman, Lahore,
                    Pakistan
                  </p>
                </div>
              </div>
                ...
                {[
                  {
                    icon: <Linkedin />,
                    name: "LinkedIn",
                    link: "https://www.linkedin.com/company/sprkcreative",
                  },
                  {
                    icon: <Instagram />,
                    name: "Instagram",
                    link: "https://www.instagram.com/sprk_creative",
                  },
                ].map((social, i) => (
                  <a
                    target="_blank"
                    href={social.link}
                    key={i}
                    className="w-12 h-12 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:border-primary hover:text-primary transition-all shadow-sm"
                  >
                    {social.icon}
                  </a>
                ))}
